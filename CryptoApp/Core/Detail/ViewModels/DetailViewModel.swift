...
class DetailViewModel: ObservableObject {
    ...
    @Published var overviweStatistics: [StatisticModel] = []
    ...
    private func mapDaataToStatistic(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> (overview: [StatisticModel], additional: [StatisticModel]) {
